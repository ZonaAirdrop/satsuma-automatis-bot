...
class SatsumaBot:
    ...
    async def perform_swap(self, private_key, token_in, token_out, amount_in):
        try:
            ...
            # Change swap_params from dict to a tuple to match ABI structure
            swap_params = (
                token_in,
                token_out,
                self.w3.to_checksum_address("0x0000000000000000000000000000000000000000"), #deployer is not relevant in this context for some contracts. Change to a valid address if needed
                account.address,
                deadline,
                amount_in_wei,
                0,
            ...
            encoded_swap_call = swap_contract.encodeABI(
